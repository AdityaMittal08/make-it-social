...
export function LoginPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center">
      <div className="border-4 border-black p-8 flex flex-col font-display gap-2 bg-[#C7E9B0] shadow-[8px_8px_0px_rgba(0,0,0,1)] rounded-2xl w-[450px] relative">
        ...
        <div>
          ...
          <input className="focus:outline-none p-2 border-4 border-black w-full rounded-lg mt-1" placeholder="Email or username" />
        </div>
        <div>
        ...
        <div className="flex-col justify-between text-sm font-bold mt-1">
          ...
          <p>New? <Link to='/signup' className="underline cursor-pointer text-blue-600">Sign up</Link></p>
        </div>
